...
const endpointName = Object.fromEntries(
    Object.entries(endpoints).map(([k, v]) => [v, k]),
);
...
export const api = {
    ...
    game: {
        ...
        start: (game, roomId, record, recordUser, player) =>
            packet(endpoints.GAME_START, {
                game_name: game,
                room_id: roomId,
                player_index: player,
                record: record,
